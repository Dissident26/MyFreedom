...
class State extends React.Component {
  state = getState(this.props.initialState);
  ...
  render() {
    return this.props.children({
      ...
      *///(!initialState) ? {} : (initialState.constructor.name === 'Object') ? initialState : {value: this.props.initialState}
      state: this.state,
      setState: (value) => this.setState(getState(value))
    });
  }
}
