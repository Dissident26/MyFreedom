...
export default function EditExpenses(props){
    ...
    const[selectedCategory, setSelectedCategory] = useState(props.element.categoryId);
    const[inputContent, setInputContent] = useState(props.element.content);
    const[inputSumm, setInputSumm] = useState(props.element.summ);
